...
output_path = static_folder + 'n_agg_Abramov_static.nc'

### to shrink the DEM use the following lat/lon corners
#for abramov
longitude_upper_left = '71.4994'
latitude_upper_left = '39.654'
longitude_lower_right = '71.596'
latitude_lower_right = '39.587'
