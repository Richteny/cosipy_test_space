...
python cosmo2cosipy.py -c ../../data/input/HEF/COSMO_forcing_1999-2010_PRESintp.csv -o ../../data/input/HEF/HEF_COSMO_point_1999_2010.nc -s ../../data/static/HEF/HEF_static_30m_raw_crop.nc -b 19990101 -e 20100101
