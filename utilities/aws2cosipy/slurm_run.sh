...
#SBATCH --chdir=/data/scratch/richteny/thesis/cosipy_test_space-v2/utilities/aws2cosipy/
...
python cosmo2cosipy.py -c ../../data/input/HEF/COSMO_forcing_1999-2010.csv -o ../../data/input/HEF/HEF_COSMO_1D10m_HORAYZON_1999_2010.nc -s ../../data/static/HEF/HEF_static_10m_elevbands.nc -b 19990102 -e 20100101 #-sx ../../data/static/HEF/HEF_static_raw.nc 
