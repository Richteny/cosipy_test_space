...
class spot_setup:
    ...
    param = alb_ice, alb_snow, alb_firn, albedo_aging, albedo_depth = [
    ...
    def simulation(self, x):
        ...
        sim_mb, sim_tsla = runcosipy(alb_ice = x.alb_ice, alb_snow = x.alb_snow, alb_firn = x.alb_firn,
...
def psample(obs, count=None):
    ...
    rep= 3000
    count=count
    name = "LHS_synth_surrogate_parameters_lowsnow"
