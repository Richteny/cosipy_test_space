...
if __name__ == "__main__":
    ...
    # RosenMC.csv file
    sampler = spotpy.algorithms.demcz(spot_setup(), dbname="RosenMC", dbformat="ram") #, parallel="mpi")

    # Now we can sample with the implemented Monte Carlo algortihm:
    sampler.sample(50000, nChains=10)  # Sample 50.000 parameter combinations
