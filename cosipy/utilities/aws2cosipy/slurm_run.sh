...
#python ./cosipy/utilities/aws2cosipy/cosmo2cosipy.py -i "./data/input/HEF/COSMO_forcing_1999-2010_PRESintp.csv" -o ./data/input/HEF/HEF_COSMO_1D20m_HORAYZON_radfix_hydro_1999_2010.nc -s ./data/static/HEF/HEF_static_1D20m_new-version.nc  -b 19990101 -e 20091231 --sw ./data/static/HEF/HEF_HORAYZON-LUT-new_1D20m.nc 
# 1D below
